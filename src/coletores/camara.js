...
class ColetorCamara extends ColetorBase {
  ...
  buildDocumentoFromRow(moduleInfo, row, pdfInfo) {
    ...
    return {
      ...
      tipo,
      numero,
      ano: this.inferirAno({ numero, dataPublicacao, titulo: title }),
      titulo: title,
        ...
        this.salvarDocumento(
          {
            ...
            numero,
            ano: this.inferirAno({ numero, dataPublicacao, titulo: link.text }),
    ...
    for (const row of rows) {
      try {
        ...
        const documento = {
          ...
          ano: this.inferirAno({ numero: inferNumero(rowText), dataPublicacao: inferDate(rowText), titulo: rowText }),
